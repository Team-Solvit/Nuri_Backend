...
public class ChatController {
    ...
    @MutationMapping
    public RoomCreateResponseDto createRoom(Principal principal, @Argument RoomCreateRequestDto roomCreateRequestDto) {
    ...
    @QueryMapping
    public Page<RoomReadResponseDto> getRooms(Principal principal, @Argument @NotNull(message = "페이지 값은 존재해야 합니다.") Integer page, @Argument @NotNull(message = "사이즈 값은 존재해야 합니다.") Integer size) {
        NuriUserDetails nuriUserDetails = (NuriUserDetails) principal;
    ...
    @QueryMapping
    public List<String> getRoomsGroupChat(Principal principal) {
        NuriUserDetails nuriUserDetails = (NuriUserDetails) principal;
    ...
    @MutationMapping
    public Boolean invite(Principal principal, @Argument RoomInviteRequestDto roomInviteRequestDto) {
        NuriUserDetails nuriUserDetails = (NuriUserDetails) principal;
    ...
    @MutationMapping
    public Boolean exit(Principal principal, @Argument @NotNull(message = "방 아이디는 존재해야 합니다.") String roomId) {
        NuriUserDetails nuriUserDetails = (NuriUserDetails) principal;
    ...
    @MutationMapping
    public Boolean kick(Principal principal, @Argument @NotNull(message = "방 아이디는 존재해야 합니다.") String roomId, @Argument @NotNull(message = "추방시킬 유저가 존재해야 합니다.") String userId) {
        NuriUserDetails nuriUserDetails = (NuriUserDetails) principal;
    ...
    @MutationMapping
    public Boolean exitRoom(Principal principal, @Argument @NotNull(message = "방 아이디는 존재해야 합니다.") String roomId) {
        NuriUserDetails nuriUserDetails = (NuriUserDetails) principal;
